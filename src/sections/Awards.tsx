  ...
  const awards = [
    {
      ...
      year: '2024',
      role: '视觉识别负责人',
      description: '负责开发赛题的视觉识别部分，展现了在计算机视觉领域的实战能力',
      icon: Cpu,
      color: '#d0ff59',
      type: '竞赛',
    },
    {
      ...
      year: '2024',
      role: '神经网络负责人',
      description: '负责神经网络搭建与数据分析工作，锻炼了数学建模与编程能力',
      icon: Target,
      color: '#49abdb',
      type: '竞赛',
    },
    {
      ...
      year: '2024',
      achievement: '三等奖',
      description: '在第九届比赛中获得三等奖，展示了系统开发与创新应用能力',
      icon: Trophy,
      color: '#ad49db',
      type: '奖项',
    },
    {
      ...
      year: '2024',
      achievement: 'SCI 3区',
      description: '发表题为"LQR-based Energy-Efficient Control for Intelligent Vehicles Optimized by Adaptive Genetic Algorithm"的论文',
      icon: FileText,
      color: '#ff9e50',
      type: '学术',
    },
