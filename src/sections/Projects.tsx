  ...
  const projects = [
    {
      ...
      title: '牙齿洁度识别系统',
      category: '计算机视觉',
      description: '与企业共同开发一款基于YOLOv11的牙齿洁度识别系统，能够准确识别牙齿洁度并分析牙齿健康程度。完成数据集标注、模型训练环境搭建，协助优化算法提高识别准确度。',
      image: '/project-dental.jpg',
      icon: Cpu,
      tags: ['YOLOv11', 'Python', 'OpenCV', '深度学习'],
    ...
    },
    {
      ...
      title: '底盘远程控制系统',
      category: '无人驾驶',
      description: '利用ROS系统、Python和控制器实现对五菱宏光mini小车的刹车、油门、转向、换挡的远程控制，为无人驾驶项目提供基础。设计远程控制系统，编写PID转向系统代码。',
